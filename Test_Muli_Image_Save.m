...
load E:\SemanticSegmentation_Scale\Results\MuliImageSS_ResNet50_SeriesClass_ResAttention\trainedNet_resnet50.mat;
InputPicBG_XPL = 'E:\B\*.png';% 背景原图的存放位置里的tif文件
InputPicPath_XPL = 'E:\B\';% 背景原图的存放位置
InputPicBG_CPL = 'E:\A\*.png';% 背景原图的存放位置里的tif文件
InputPicPath_CPL='E:\A\';% 背景原图的存放位置

SavePathName = 'E:\MuliImageSS_ResNet50_SeriesClass_ResAttention\';% 文件保存路径
prefix='_';% 文件名前缀
format='png';% 文件格式
