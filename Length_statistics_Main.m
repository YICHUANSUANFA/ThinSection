clc
clear
InputPicBG = 'E:\TYUT\岩石薄片识别\论文\尺寸大小占比\MuliImageSS_ResNet50_SeriesClass_ResAttention\*.png';% 背景原图的存放位置里的tif文件
InputPicPath = 'E:\TYUT\岩石薄片识别\论文\尺寸大小占比\MuliImageSS_ResNet50_SeriesClass_ResAttention\';% 背景原图的存放位置
