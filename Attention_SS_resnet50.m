...
tempLayers = imageInputLayer([224 224 6],"Name","input_1");
...
tempLayers = [
    WeightedAdditionLayer("add1",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add2",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add3",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add4",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add5",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add6",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add7",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add8",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add9",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add10",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add11",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add12",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add13",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add14",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add15",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add16",["in1" "in2"],"out")
...
tempLayers = [
    WeightedAdditionLayer("add17",["in1" "in2"],"out")
    ...
    convolution2dLayer([1 1],14,"Name","scorer","BiasLearnRateFactor",0,"WeightLearnRateFactor",10)
    transposedConv2dLayer([8 8],14,"Name","dec_upsample2","BiasLearnRateFactor",0,"Cropping",[2 2 2 2],"Stride",[4 4],"WeightLearnRateFactor",0)];
lgraph = addLayers(lgraph,tempLayers);
...
lgraph = connectLayers(lgraph,"bn2a_branch1","add1/in1");
lgraph = connectLayers(lgraph,"bn2a_branch2c","add1/in2");
lgraph = connectLayers(lgraph,"activation_4_relu","res2b_branch2a");
lgraph = connectLayers(lgraph,"activation_4_relu","add2/in1");
lgraph = connectLayers(lgraph,"bn2b_branch2c","add2/in2");
lgraph = connectLayers(lgraph,"activation_7_relu","res2c_branch2a");
lgraph = connectLayers(lgraph,"activation_7_relu","add3/in1");
lgraph = connectLayers(lgraph,"bn2c_branch2c","add3/in2");
...
lgraph = connectLayers(lgraph,"bn3a_branch1","add4/in1");
lgraph = connectLayers(lgraph,"bn3a_branch2c","add4/in2");
lgraph = connectLayers(lgraph,"activation_13_relu","res3b_branch2a");
lgraph = connectLayers(lgraph,"activation_13_relu","add5/in1");
lgraph = connectLayers(lgraph,"bn3b_branch2c","add5/in2");
lgraph = connectLayers(lgraph,"activation_16_relu","res3c_branch2a");
lgraph = connectLayers(lgraph,"activation_16_relu","add6/in1");
lgraph = connectLayers(lgraph,"bn3c_branch2c","add6/in2");
lgraph = connectLayers(lgraph,"activation_19_relu","res3d_branch2a");
lgraph = connectLayers(lgraph,"activation_19_relu","add7/in1");
lgraph = connectLayers(lgraph,"bn3d_branch2c","add7/in2");
...
lgraph = connectLayers(lgraph,"bn4a_branch1","add8/in2");
lgraph = connectLayers(lgraph,"bn4a_branch2c","add8/in1");
lgraph = connectLayers(lgraph,"activation_25_relu","res4b_branch2a");
lgraph = connectLayers(lgraph,"activation_25_relu","add9/in1");
lgraph = connectLayers(lgraph,"bn4b_branch2c","add9/in2");
lgraph = connectLayers(lgraph,"activation_28_relu","res4c_branch2a");
lgraph = connectLayers(lgraph,"activation_28_relu","add10/in1");
lgraph = connectLayers(lgraph,"bn4c_branch2c","add10/in2");
lgraph = connectLayers(lgraph,"activation_31_relu","res4d_branch2a");
lgraph = connectLayers(lgraph,"activation_31_relu","add11/in1");
lgraph = connectLayers(lgraph,"dec_relu2","dec_crop1/ref");
lgraph = connectLayers(lgraph,"dec_relu2","add17/in1");
lgraph = connectLayers(lgraph,"bn4d_branch2c","add11/in2");
lgraph = connectLayers(lgraph,"activation_34_relu","res4e_branch2a");
lgraph = connectLayers(lgraph,"activation_34_relu","add12/in1");
lgraph = connectLayers(lgraph,"bn4e_branch2c","add12/in2");
lgraph = connectLayers(lgraph,"activation_37_relu","res4f_branch2a");
lgraph = connectLayers(lgraph,"activation_37_relu","add13/in1");
lgraph = connectLayers(lgraph,"bn4f_branch2c","add13/in2");
...
lgraph = connectLayers(lgraph,"bn5a_branch1","add14/in1");
lgraph = connectLayers(lgraph,"bn5a_branch2c","add14/in2");
lgraph = connectLayers(lgraph,"activation_43_relu","res5b_branch2a");
lgraph = connectLayers(lgraph,"activation_43_relu","add15/in1");
lgraph = connectLayers(lgraph,"bn5b_branch2c","add15/in2");
lgraph = connectLayers(lgraph,"activation_46_relu","res5c_branch2a");
lgraph = connectLayers(lgraph,"activation_46_relu","add16/in1");
lgraph = connectLayers(lgraph,"bn5c_branch2c","add16/in2");
...
lgraph = connectLayers(lgraph,"dec_crop1","add17/in2");
