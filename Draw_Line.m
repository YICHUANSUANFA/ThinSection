% A应当为测试所需的label图
A = imread('E:\TYUT\岩石薄片识别\论文\尺寸大小占比\Label_对比图8.png');
...
figure
imshow(A)
% text([0 1],[0 1],{'first','second'})
% text(R_Dis_C,R_Dis_R,suffix,'horiz','center','Color','red','FontSize',14);
text(C_Dis_C,C_Dis_R,suffix,'horiz','center','Color','red','FontSize',14);
% imwrite(A,'E:\TYUT\岩石薄片识别\论文\论文对比图九\对比图5.png');
% A=bitmaptext(lines,A,[100 100],struct('Color',[1 1 1 1]));