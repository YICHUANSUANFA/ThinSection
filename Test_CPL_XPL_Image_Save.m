...
load E:\SemanticSegmentation_Scale\Results\CPL_ResNet50_Class_No_Attention\trainedNet_resnet50.mat;
InputPicBG='E:\CPL_XPL_MULI\A\*.png';% 背景原图的存放位置里的tif文件
InputPicPath='E:\CPL_XPL_MULI\A\';% 背景原图的存放位置
SavePathName='E:\CPL_XPL_MULI\A_Test_CPL_NoAttention\';% 文件保存路径
prefix='_';% 文件名前缀
format='png';% 文件格式
